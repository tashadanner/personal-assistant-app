class PersonalAssistant:
  def __init__(self, todos):
    ...
    self.birthdays = {
      'Neal': '3/8/1970', 'Kathy': '10/14/1949', 'Tom': '11/4/1948', 'Jon': '12/29/1948', 'Toby': '4/17/1969'
    }
    self.todos = todos
  ...
  def add_birthday(self, name, birthday):
    if name in self.birthdays:
      return "Already a birthday for this person."
    else:
  ...
  def remove_birthday(self, name):
    if name in self.birthdays:
      ...
      return "There is no birthday for this person."
